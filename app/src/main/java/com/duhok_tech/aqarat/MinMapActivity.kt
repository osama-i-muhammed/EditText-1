...
class MinMapActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arHouse.add(House(0, 1, "Grebase, Ashty", 8, 350.0, 2, 2, 1, 0, 230.0, 36.874129, 42.981419))
        arHouse.add(House(1, 2, "Grebase, Ashty", 6, 180000.0, 2, 2, 1, 1, 230.0, 36.874421, 42.987438))
        arHouse.add(House(2, 1, "Grebase, Ashty", 7, 250.0, 2, 2, 1, 9, 230.0, 36.868696, 42.991772))
        arHouse.add(House(3, 2, "Grebase, Ashty", 5, 276000.0, 2, 2, 1, 0, 230.0, 36.868953, 42.993686))
        arHouse.add(House(4, 1, "Grebase, Ashty", 4, 400.0, 2, 2, 1, 5, 230.0, 36.864176, 42.987600))
        arHouse.add(House(5, 2, "Grebase, Ashty", 3, 254000.0, 2, 2, 1, 0, 230.0, 36.861830, 42.966947))
        arHouse.add(House(6, 1, "Grebase, Ashty", 3, 700.0, 2, 2, 1, 3, 230.0, 36.852181, 42.985830))
        arApart.add(Apartment(0, 2, "AvroCity b5 5", 2, 105000.0, 2, 2, 1, 230.0, 36.868104, 42.980557))
        arApart.add(Apartment(1, 1, "AvroCity b5 5", 3, 300.0, 2, 2, 1, 230.0, 36.857014, 42.907024))
        arApart.add(Apartment(2, 2, "AvroCity b5 5", 5, 105000.0, 2, 2, 1, 230.0, 36.861057, 42.909167))
        arApart.add(Apartment(3, 1, "AvroCity b5 5", 21, 500.0, 2, 2, 1, 230.0, 36.866410, 42.978087))
